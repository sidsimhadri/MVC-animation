...
/**
 * My implementation for the provider's ellipse.
 */
public class Ellipse extends AbstractShape implements ProviderShape {


  public Ellipse(double width, double height, IColor color, IPosn pos) {
    super(width, height, color, pos);
  }


  public Ellipse(IShape s) {
  ...
  public ProviderShape copyShape() {
    return new Ellipse(this.getWidth(), this.getHeight(), this.getColor(), this.getPosition());
  }
